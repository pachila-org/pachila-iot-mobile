...
public class SystemWebChromeClient extends WebChromeClient {
	...
	public void onConsoleMessage(String message, int lineNumber, String sourceID) {
		...
		if (android.os.Build.VERSION.SDK_INT == android.os.Build.VERSION_CODES.ECLAIR_MR1) {
			// LOG.d(LOG_TAG, "%s: Line %d : %s", sourceID, lineNumber,
			// message);
			Log.i("SICON", "Source:" + sourceID + ", LineNumber: " + lineNumber + ",Msg:" + message);
	...
	public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
		if (consoleMessage.message() != null)
			...
			Log.i("SICON", "Source:" + consoleMessage.sourceId() + ", LineNumber: " + consoleMessage.lineNumber() + ",Msg:" + consoleMessage.message());
	 ...
	 *
	 * This also checks for the Geolocation Plugin and requests permission from
	 * the application to use Geolocation.
	 *
	 * @param origin
	 * @param callback
	 */
